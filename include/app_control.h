...
/**
 * @brief Set the default application(package name) associated with operation, mime-type and uri.
 *
 * @since_tizen 3.0
 * @privlevel platform
...
/**
 * @brief Unset the default application(package name) associated with operation, mime-type and uri.
 *
 * @since_tizen 3.0
 * @privlevel platform
 * @privilege %http://tizen.org/privilege/systemsettings.admin
