...
{
	return app_control_send_launch_request_with_uid(app_control, callback, getuid(), user_data);
}

int app_control_send_launch_request_with_uid(app_control_h app_control, app_control_reply_cb callback, uid_t uid, void *user_data)
{
	const char *operation;
